...
__all__ = [
    'STCRemoteServer', 'SPINTERFERENCE_TOOQUIET',
    'DISPID_SPIGrammarId', 'SpeechEmulationCompareFlags',
    'DISPID_SRGCommit', 'SP_VISEME_2', 'SpeechRuleAttributes',
    'ISpeechRecoResult2', 'SPAS_STOP', 'DISPID_SRGSetTextSelection',
    'eLEXTYPE_PRIVATE9', 'DISPID_SVSCurrentStreamNumber',
    'SVEPhoneme', 'DISPID_SRCESoundEnd', 'DISPID_SPIProperties',
    'DISPID_SpeechRecognizer', 'SPINTERFERENCE_NONE',
    'DISPID_SGRSTType', 'DISPID_SAVolume',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'ISpeechObjectTokens', 'DISPID_SPPChildren', 'ISpRecognizer',
    'SGPronounciation', 'SPEI_SOUND_START', 'DISPID_SDKDeleteValue',
    'DISPID_SRCEEnginePrivate', 'DISPID_SOTCGetDataKey', 'SDTRule',
    'SP_VISEME_11', 'DISPID_SRCEStartStream',
    'SAFTCCITT_ALaw_8kHzStereo', 'DISPID_SPRuleId', 'DISPID_SFSClose',
    'ISpeechFileStream', 'SPEI_SR_BOOKMARK', 'SPPHRASE',
    'SpResourceManager', 'SAFT16kHz8BitMono', 'DISPID_SBSRead',
    'STCInprocHandler', 'SDTAll', 'SECFDefault', 'DISPID_SRGReset',
    'SGRSTTWildcard', 'DISPID_SGRAddResource', 'SVEStartInputStream',
    'SpeechTokenKeyFiles', 'DISPID_SPRuleConfidence',
    'DISPID_SDKDeleteKey', 'DISPID_SDKGetBinaryValue',
    'ISpObjectToken', 'DISPID_SpeechVoiceEvent',
    'DISPID_SRCEBookmark', 'SVSFPurgeBeforeSpeak',
    'DISPID_SMSGetData', 'SPDKL_CurrentConfig',
    'ISpeechGrammarRuleStateTransitions', 'LONG_PTR',
    'DISPID_SLWsItem', 'SRERequestUI', 'SPEI_RESERVED1',
    'ISpeechPhraseProperty', 'DISPID_SpeechPhraseElements',
    'DISPID_SABufferNotifySize', 'DISPID_SpeechRecoContextEvents',
    'SPSNoun', 'DISPID_SpeechFileStream', 'DISPID_SLWsCount',
    'SPEI_VISEME', 'ISpeechRecoContext', 'DISPID_SPAsItem',
    'SpeechDictationTopicSpelling', 'DISPID_SPEs_NewEnum',
    'SGRSTTRule', 'SPEI_UNDEFINED', 'SECFIgnoreWidth', 'SP_VISEME_10',
    'SPEI_PHRASE_START', 'SpeechGrammarState',
    'DISPID_SPRDisplayAttributes', 'DISPID_SPIRetainedSizeBytes',
    'DISPID_SPIEnginePrivateData', 'SGDSInactive',
    'DISPID_SWFEChannels', 'SRSActiveAlways',
    'SpeechPropertyLowConfidenceThreshold',
    'DISPID_SPIGetDisplayAttributes', 'DISPID_SPPFirstElement',
    'SPSEMANTICERRORINFO', 'SPDATAKEYLOCATION', 'SDTDisplayText',
    'DISPID_SRRDiscardResultInfo', 'DISPID_SPPName',
    'ISpPhoneticAlphabetSelection', 'SpeechRegistryLocalMachineRoot',
    'eLEXTYPE_RESERVED8', 'SPSMF_SAPI_PROPERTIES',
    'DISPID_SPEAudioSizeBytes', 'DISPID_SPPValue', 'ISpRecognizer2',
    'ISpeechDataKey', 'SVP_5', 'DISPID_SpeechPhraseInfo',
    'SPSHORTCUTTYPE', 'DISPID_SpeechDataKey', 'SPPARTOFSPEECH',
    'SPINTERFERENCE_TOOSLOW', 'eLEXTYPE_PRIVATE19',
    '__MIDL_IWinTypes_0009', 'SSTTWildcard', 'SpeechAudioFormatType',
    'SpLexicon', 'SRADynamic', 'DISPID_SVIsUISupported',
    'DISPID_SWFEFormatTag', 'SPRS_ACTIVE_USER_DELIMITED',
    'DISPID_SRGCmdSetRuleState', 'DISPID_SDKSetLongValue',
    'eLEXTYPE_PRIVATE14', 'DISPID_SRRSetTextFeedback',
    'DISPID_SRRAlternates', 'SPCT_SLEEP', 'ISpeechVoiceStatus',
    'DISPID_SGRSTPropertyId', 'SAFTCCITT_uLaw_8kHzStereo',
    'SpeechUserTraining', 'SpSharedRecoContext',
    'SPEI_SR_RETAINEDAUDIO', 'DISPID_SOTCreateInstance', 'SITooSlow',
    'DISPID_SVGetProfiles', 'SPAO_RETAIN_AUDIO', 'SPSInterjection',
    'DISPID_SVEBookmark', 'SP_VISEME_12', 'DISPID_SPRsCount',
    'ISpeechXMLRecoResult', 'DISPID_SPRNumberOfElements',
    'SpeechTokenValueCLSID', 'SPCATEGORYTYPE', 'SREStreamStart',
    'SAFTCCITT_ALaw_22kHzStereo', 'SDTAlternates',
    'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE', 'DISPID_SGRSTWeight',
    'SASClosed', 'SPTEXTSELECTIONINFO', 'DISPID_SPRuleChildren',
    'SAFTCCITT_uLaw_8kHzMono', 'SpeechTokenContext',
    'SPEI_REQUEST_UI', 'SP_VISEME_6', 'SpPhoneticAlphabetConverter',
    'SAFTExtendedAudioFormat', 'SPRULESTATE', 'DISPID_SPRText',
    'ISpSerializeState', 'SPGRAMMARSTATE', 'DISPID_SVEVoiceChange',
    'DISPID_SLGetGenerationChange', 'SPRST_NUM_STATES',
    'SPGS_EXCLUSIVE', 'DISPID_SPPsItem', 'DISPID_SRRGetXMLResult',
    'DISPID_SRRTimes', 'SPINTERFERENCE_TOOFAST',
    'SAFT44kHz16BitStereo', 'DISPID_SADefaultFormat',
    'DISPID_SGRSTRule', 'SPRULE', 'ISpStream',
    'SWPKnownWordPronounceable', 'DISPID_SGRSTNextState',
    'DISPID_SPIGetText', 'DISPID_SVEStreamStart',
    'SpeechVoiceSpeakFlags', 'DISPID_SWFESamplesPerSec',
    'SREAllEvents', 'SFTInput', 'DISPID_SWFEExtraData',
    'DISPID_SRGSetWordSequenceData', 'ISpRecoContext', 'SpMMAudioOut',
    'STSF_CommonAppData', 'SpeechAudioFormatGUIDText',
    'ISpObjectWithToken', 'DISPID_SpeechPhraseReplacements',
    'ISpeechLexiconPronunciations', 'SPADAPTATIONRELEVANCE',
    'DISPID_SLPsCount', 'SpeechTokenKeyUI',
    'IInternetSecurityMgrSite', 'SPEVENT', 'DISPID_SGRSTsCount',
    'STCInprocServer', 'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C',
    'SAFT8kHz16BitMono', 'SPEI_ACTIVE_CATEGORY_CHANGED',
    'DISPID_SOTId', 'DISPID_SVResume', 'STSF_FlagCreate',
    'SPWORDLIST', 'SVP_21', 'SREPropertyStringChange',
    'DISPIDSPTSI_SelectionLength', 'DISPID_SGRsCount',
    'DISPID_SPEsItem', 'DISPID_SVEAudioLevel', 'SPPS_SuppressWord',
    'tagSPTEXTSELECTIONINFO', 'DISPID_SGRSTs_NewEnum',
    'DISPID_SOTCSetId', 'SRERecognition', 'SREStateChange',
    'SPEI_TTS_AUDIO_LEVEL', 'SPRECORESULTTIMES',
    'DISPID_SpeechMMSysAudio', 'SSFMCreate', 'SPLO_DYNAMIC',
    'DISPID_SPRulesCount', 'SPSMF_SRGS_SEMANTICINTERPRETATION_MS',
    'SPEI_RECO_OTHER_CONTEXT', 'SpeechDiscardType',
    'SRADefaultToActive', 'SPPS_Modifier', 'SPSTREAMFORMATTYPE',
    'DISPID_SOTGetAttribute', 'DISPID_SOTsItem', 'SGRSTTWord',
    'SpUnCompressedLexicon', 'DISPID_SLPLangId',
    'DISPID_SPRFirstElement', 'DISPID_SVVolume',
    'DISPID_SDKSetBinaryValue', 'DISPID_SPEEngineConfidence',
    ...
    'DISPID_SGRSTText', 'DISPID_SpeechCustomStream', 'SP_VISEME_0',
    'ISpPhraseAlt', 'DISPID_SPRuleName', 'SPEI_VOICE_CHANGE',
    'SPINTERFERENCE_NOISE', 'SPAUDIOSTATE', 'ISpeechRecoResult',
    'SPWT_PRONUNCIATION', 'SGSDisabled', 'SPDKL_CurrentUser',
    'SPGS_DISABLED', 'SPLO_STATIC', 'SLTApp',
    'SAFTCCITT_uLaw_44kHzMono', 'SPEVENTENUM', 'SPSVerb',
    'SRCS_Disabled', 'DISPIDSPTSI_ActiveOffset',
    'DISPID_SOTs_NewEnum', 'SPSModifier', 'SPDKL_DefaultLocation',
    'DISPID_SLPPartOfSpeech', 'DISPID_SWFEBitsPerSample',
    'SPEI_PHONEME', 'eLEXTYPE_PRIVATE6', 'SPSFunction',
    'SPPROPERTYINFO', 'IStream', 'DISPID_SPPBRestorePhraseFromMemory',
    'SAFT32kHz16BitMono', 'SpeechAudioProperties', 'DISPID_SAFType',
    'DISPID_SASNonBlockingIO', 'SpTextSelectionInformation',
    'SDKLCurrentUser', 'SPBO_AHEAD', 'SRTAutopause',
    'DISPID_SLWs_NewEnum', 'SAFTADPCM_8kHzStereo',
    'DISPID_SVEPhoneme', 'DISPID_SVSRunningState', 'DISPID_SLPsItem',
    'SPSERIALIZEDRESULT', 'SPAR_Low', 'DISPID_SRGRecoContext',
    'eLEXTYPE_RESERVED6', 'SpeechVoicePriority',
    'SDA_One_Trailing_Space', 'ISpRecognizer3', 'SPEI_RECOGNITION',
    'SP_VISEME_14', 'DISPID_SPARecoResult', 'DISPID_SpeechLexicon',
    'SPRECOSTATE', 'SVP_14', 'SPPHRASEELEMENT', 'SPAO_NONE',
    'eLEXTYPE_USER', 'SPLEXICONTYPE', 'DISPID_SGRsFindRule',
    'SpeechAudioState', 'DISPID_SRIsShared',
    'SpeechWordPronounceable', 'SAFT11kHz8BitStereo', 'SPVPRI_NORMAL',
    'DISPID_SVSkip', 'SPBO_TIME_UNITS', 'SPEI_MIN_SR',
    'ISpeechPhraseProperties', 'SRSEDone', 'SAFT24kHz8BitStereo',
    'SVSFUnusedFlags', 'ISpeechCustomStream', 'ISpGrammarBuilder',
    'SpeechGrammarTagWildcard', 'SAFTADPCM_44kHzMono',
    'SPINTERFERENCE_NOSIGNAL', 'SRARoot', 'SAFT12kHz8BitMono',
    'SRESoundStart', 'DISPID_SpeechAudioFormat', 'SVPOver',
    'DISPID_SLPs_NewEnum', 'SpeechStreamSeekPositionType',
    'ISpeechGrammarRules', 'SPAR_Medium', 'SpFileStream',
    'ISpeechObjectTokenCategory', 'eLEXTYPE_PRIVATE10',
    'SpeechPartOfSpeech', 'SPRST_ACTIVE_ALWAYS', 'SVSFParseSsml',
    'DISPID_SpeechRecoResult', 'DISPID_SOTCDefault',
    'ISpeechRecoResultTimes', 'SPEI_RESERVED6',
    'SpStreamFormatConverter', '_ISpeechVoiceEvents',
    'DISPID_SVSpeakStream', 'SpPhraseInfoBuilder',
    'eLEXTYPE_RESERVED7', 'ISpStreamFormatConverter',
    'DISPID_SPPsCount', 'SPINTERFERENCE_LATENCY_TRUNCATE_END',
    'SGSEnabled', 'SVSFlagsAsync', 'DISPID_SDKEnumValues',
    'DISPID_SRGCmdSetRuleIdState', 'SRSActive', 'SGRSTTEpsilon',
    'DISPID_SPEActualConfidence', 'DISPID_SAStatus',
    'ISpeechGrammarRule', 'DISPID_SRRTLength', 'DISPID_SPIEngineId',
    'SAFT12kHz16BitMono', 'DISPID_SpeechWaveFormatEx',
    'SpeechVoiceSkipTypeSentence', 'SPWORDPRONUNCIATION',
    'SPCONTEXTSTATE', 'SVPAlert', 'SPVPRIORITY',
    'SAFT11kHz16BitStereo', 'DISPID_SLWPronunciations',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002', 'SpeechRecognitionType',
    'DISPID_SpeechRecoResultTimes',
    'SpeechGrammarRuleStateTransitionType',
    'ISpeechPhraseReplacement', 'SAFT12kHz16BitStereo',
    'SpeechPropertyAdaptationOn', 'eLEXTYPE_PRIVATE5', 'DISPID_SGRId',
    'ISpRecoContext2', 'DISPID_SASFreeBufferSpace', 'ISpDataKey',
    'SP_VISEME_17', 'SPEI_RESERVED2', 'DISPID_SPPConfidence',
    'SAFT22kHz8BitMono', 'SP_VISEME_21', 'SGDSActiveUserDelimited',
    'SVP_10', 'SpShortcut', 'DISPID_SGRsItem', 'DISPID_SGRName',
    'SSSPTRelativeToEnd', 'SVPNormal', 'SBONone',
    'SAFTADPCM_22kHzStereo', 'SINone', 'SPEI_RESERVED5',
    'SpeechVisemeType', 'DISPID_SRRTStreamTime',
    'SpeechGrammarWordType', 'DISPID_SPAPhraseInfo',
    'DISPID_SOTSetId', 'SPEI_TTS_PRIVATE', 'DISPID_SpeechLexiconWord',
    'DISPID_SRGetRecognizers', 'SpeechAudioVolume', 'SPFM_CREATE',
    'SASRun', 'ISpRecoCategory', 'SpWaveFormatEx',
    'DISPID_SLRemovePronunciation', 'DISPID_SPPId',
    'DISPID_SRGCmdLoadFromFile', 'DISPID_SVDisplayUI',
    'ISpeechLexiconWord', 'SPSLMA', 'SpeechRecognizerState',
    'DISPID_SpeechAudio', 'DISPID_SRGetFormat', 'SVP_18',
    'DISPID_SRGId', 'DISPID_SRGetPropertyNumber',
    'DISPID_SRGDictationUnload', 'DISPID_SRProfile',
    'eLEXTYPE_MORPHOLOGY', 'SLTUser', 'SPVPRI_ALERT',
    'DISPID_SPCPhoneToId', 'SAFT12kHz8BitStereo', 'DISPID_SPAsCount',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'SpeechAudioFormatGUIDWave', 'DISPID_SPILanguageId',
    'SAFT22kHz16BitStereo', 'SAFTADPCM_11kHzMono',
    'DISPID_SRRSpeakAudio', 'SpStream', 'SPAR_High',
    'DISPID_SVPriority', 'SRSInactive', 'DISPID_SRRTTickCount',
    'SAFTADPCM_11kHzStereo', 'SpeechEngineConfidence',
    'ISpeechPhraseElements', 'DISPID_SRRAudio',
    'SAFTADPCM_44kHzStereo', 'ISpShortcut', 'DISPID_SPRulesItem',
    'DISPID_SVVoice', 'DISPID_SLWLangId', 'SpeechLoadOption',
    'ISpeechTextSelectionInformation', 'DISPID_SRCRecognizer',
    'SpeechWordType', 'SPEI_START_INPUT_STREAM',
    'DISPID_SRSCurrentStreamPosition', 'SPPS_Unknown',
    'SPRS_INACTIVE', 'SpNullPhoneConverter', 'DISPID_SDKEnumKeys',
    'ISequentialStream', 'eLEXTYPE_PRIVATE7',
    'DISPID_SRCCreateGrammar', 'SVEVoiceChange',
    'DISPID_SRCERecognizerStateChange',
    'DISPID_SPIAudioStreamPosition', 'DISPID_SpeechObjectToken',
    'SAFT8kHz8BitStereo', 'SVSFIsNotXML', 'DISPID_SGRsCommit',
    'SPEI_MAX_TTS', 'SVP_3', 'DISPID_SPRuleParent', 'SPAUDIOOPTIONS',
    'DISPID_SLRemovePronunciationByPhoneIds', 'SVP_13',
    'tagSPPROPERTYINFO', 'SPEI_PROPERTY_NUM_CHANGE',
    'SPPS_Interjection', 'eLEXTYPE_PRIVATE8', 'ISpLexicon',
    'DISPID_SGRSTPropertyName', 'SPEI_END_SR_STREAM',
    'DISPID_SABIBufferSize', 'SpObjectTokenCategory', 'SVF_Emphasis',
    'DISPID_SRRPhraseInfo', 'SPEI_MIN_TTS',
    'SpeechPropertyResponseSpeed', 'DISPID_SpeechRecoContext',
    'SP_VISEME_16', 'ISpeechRecognizer', 'SPVISEMES',
    'DISPID_SAFGuid', 'DISPID_SVSInputWordPosition',
    'DISPID_SOTRemove', 'DISPID_SBSSeek', '_RemotableHandle',
    'SP_VISEME_13', 'DISPID_SLPPhoneIds',
    'DISPID_SpeechPhraseAlternate', 'ISpeechGrammarRuleState',
    'ISpeechRecoResultDispatch', 'SPEI_END_INPUT_STREAM',
    'SAFTGSM610_44kHzMono', 'DISPID_SPIAudioSizeBytes',
    'SPAUDIOSTATUS', 'DISPID_SMSALineId', 'ISpeechMemoryStream',
    'DISPID_SVSpeak', 'DISPID_SDKCreateKey',
    'DISPID_SPERetainedStreamOffset', 'SPWAVEFORMATTYPE',
    'DISPID_SPIRule', 'DISPID_SPAStartElementInResult',
    'DISPID_SOTCId', 'SPPS_RESERVED4', 'DISPID_SVRate', 'IEnumString',
    'SSFMCreateForWrite', 'SDTAudio', 'DISPID_SRDisplayUI',
    'IInternetSecurityManager', 'SAFT24kHz16BitMono',
    'SPINTERFERENCE_LATENCY_WARNING', 'DISPID_SRCEHypothesis',
    'SVEAudioLevel', 'SPAS_CLOSED', 'DISPID_SpeechLexiconWords',
    'SpeechCategoryAudioOut', 'ISpeechLexiconWords',
    'DISPID_SGRSTransitions', 'SPXRO_SML',
    'DISPID_SGRSAddSpecialTransition', 'SPEI_MAX_SR', 'SGLexical',
    'Speech_StreamPos_Asap', 'SGDSActive',
    'SpeechCategoryRecoProfiles', 'DISPID_SLAddPronunciation',
    'DISPID_SPELexicalForm', 'DISPID_SOTDisplayUI',
    'SPEVENTSOURCEINFO', 'SECFIgnoreKanaType', 'ISpRecoGrammar',
    'SVP_7', 'SPWP_KNOWN_WORD_PRONOUNCEABLE', 'SpInprocRecognizer',
    'DISPID_SRCSetAdaptationData', 'DISPID_SRCResume',
    'DISPID_SPRuleEngineConfidence', 'SAFT8kHz16BitStereo',
    'DISPID_SpeechGrammarRuleState', 'ISpNotifySource', 'SPFILEMODE',
    'SpeechPropertyResourceUsage', 'ISpProperties',
    'SAFTCCITT_uLaw_44kHzStereo', 'ISpeechAudioBufferInfo',
    'SP_VISEME_18', 'SAFT48kHz8BitMono',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet', 'DISPIDSPTSI',
    'DISPID_SAEventHandle', 'SpeechInterference',
    'DISPID_SOTGetDescription', 'SVESentenceBoundary',
    'SPEI_ADAPTATION', 'SPWORD', 'SAFTCCITT_ALaw_22kHzMono',
    'eLEXTYPE_PRIVATE15', 'SREInterference',
    'DISPID_SPERetainedSizeBytes', 'DISPID_SPIReplacements',
    'SPVOICESTATUS', 'eLEXTYPE_RESERVED9', 'ISpEventSink',
    'ISpPhoneConverter', 'SAFTADPCM_22kHzMono', 'SREBookmark',
    'DISPID_SLGenerationId', 'STSF_LocalAppData',
    'DISPID_SRCCreateResultFromMemory',
    'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'SPLOADOPTIONS',
    'DISPID_SRGCmdLoadFromResource', 'eLEXTYPE_APP', 'DISPIDSPRG',
    'SAFT11kHz16BitMono', 'SGDisplay', 'DISPID_SRAudioInput',
    'STSF_AppData', 'SAFTCCITT_ALaw_44kHzStereo',
    'DISPID_SABufferInfo', 'SVSFNLPMask', 'DISPID_SRRAudioFormat',
    'SAFTCCITT_uLaw_11kHzMono', 'DISPID_SPISaveToMemory',
    'SAFTCCITT_ALaw_11kHzMono', 'eLEXTYPE_PRIVATE20',
    'DISPID_SVGetAudioOutputs', 'SVEAllEvents', 'SRSEIsSpeaking',
    'DISPID_SGRSTPropertyValue', 'DISPID_SpeechPhraseProperties',
    'SpeechLexiconType', 'SGLexicalNoSpecialChars', 'UINT_PTR',
    'SpeechRegistryUserRoot', 'SPEI_FALSE_RECOGNITION',
    'DISPID_SWFEAvgBytesPerSec',
    'DISPID_SRCAudioInInterferenceStatus', 'DISPID_SMSAMMHandle',
    'SSSPTRelativeToStart', 'SAFTGSM610_11kHzMono',
    'SAFTGSM610_22kHzMono', 'DISPID_SPEAudioStreamOffset',
    'SPFM_OPEN_READONLY', 'ISpeechLexicon', 'ISpeechPhraseRules',
    'SRAExport', 'DISPID_SRCERecognitionForOtherContext',
    'DISPID_SRSetPropertyNumber', 'SRESoundEnd', 'SVP_4',
    'DISPID_SRCEAudioLevel', 'SPRECOCONTEXTSTATUS',
    'DISPID_SRCEPropertyNumberChange', 'SPSMF_SRGS_SAPIPROPERTIES',
    'SPWORDPRONUNCIATIONLIST', 'DISPID_SpeechPhraseElement',
    'DISPID_SpeechGrammarRule', 'DISPID_SRRecognizer',
    'DISPID_SPIElements', 'DISPID_SRCEFalseRecognition',
    'DISPID_SLPSymbolic', 'DISPID_SGRInitialState',
    'DISPID_SRSetPropertyString', 'DISPID_SGRsAdd',
    'DISPID_SPEAudioSizeTime', 'SPGRAMMARWORDTYPE', 'SREAudioLevel',
    'DISPID_SOTGetStorageFileName', 'DISPID_SPRuleFirstElement',
    'SREPropertyNumChange', 'SAFT48kHz8BitStereo',
    'SpeechPropertyNormalConfidenceThreshold', 'SVEEndInputStream',
    'eLEXTYPE_PRIVATE2', 'DISPID_SGRsCommitAndSave',
    'DISPID_SRCERecognition', 'SECNormalConfidence',
    'SpeechEngineProperties', 'SP_VISEME_15', 'SAFT16kHz16BitMono',
    'SVEViseme', 'SpCustomStream', 'SPPS_LMA',
    'ISpeechPhraseInfoBuilder', 'SpeechCategoryAppLexicons',
    'SPPS_Noncontent', 'ISpeechAudioStatus', 'SPDKL_LocalMachine',
    'SAFTNonStandardFormat', 'DISPID_SRCEPropertyStringChange',
    'SPWF_INPUT', 'SpPhoneConverter', 'SVP_8',
    'SDA_No_Trailing_Space', 'SSTTTextBuffer', 'DISPID_SCSBaseStream',
    'SpeechCategoryVoices', 'DISPID_SVAlertBoundary',
    'SPEI_HYPOTHESIS', 'SpeechPropertyComplexResponseSpeed',
    'SRTStandard', 'DISPID_SVSLastResult', 'ISpeechPhraseElement',
    'DISPID_SVSLastBookmarkId', 'DISPID_SRState',
    'eLEXTYPE_PRIVATE12', 'SPEI_TTS_BOOKMARK', 'SpeechStreamFileMode',
    'DISPID_SRGCmdLoadFromObject', 'DISPID_SRGIsPronounceable',
    'DISPID_SPANumberOfElementsInResult', 'SRTSMLTimeout',
    'DISPID_SVEWord', 'DISPID_SDKSetStringValue', 'SDKLLocalMachine',
    'DISPID_SVGetVoices', 'DISPID_SpeechMemoryStream',
    'DISPID_SVStatus', 'SPINTERFERENCE_TOOLOUD',
    'DISPID_SPRules_NewEnum', 'DISPID_SPACommit',
    'DISPID_SpeechGrammarRuleStateTransition', 'ISpeechPhraseInfo',
    'SPEI_SENTENCE_BOUNDARY', 'SAFTCCITT_uLaw_22kHzStereo',
    'DISPID_SpeechPhraseBuilder', 'SpeechRuleState',
    'SPEI_SR_AUDIO_LEVEL', 'SVEWordBoundary',
    'SPWP_UNKNOWN_WORD_PRONOUNCEABLE', 'DISPID_SFSOpen',
    'SpeechRetainedAudioOptions', 'SpVoice', 'SpMMAudioIn',
    'DISPID_SVSVisemeId', 'SpeechDataKeyLocation',
    'SpeechVoiceCategoryTTSRate', 'SpeechCategoryRecognizers',
    'DISPID_SASetState', 'DISPID_SPRsItem', 'SREAdaptation',
    'SLOStatic', 'DISPID_SPPNumberOfElements', 'SAFT44kHz8BitStereo',
    'SPINTERFERENCE', 'DISPID_SVSpeakCompleteEvent',
    'SDA_Two_Trailing_Spaces', 'SPVPRI_OVER', 'SpeechRecoEvents',
    'SRTReSent', 'eLEXTYPE_PRIVATE1', 'ISpXMLRecoResult',
    'DISPID_SRCEventInterests', 'DISPID_SRCEPhraseStart',
    'SpeechRunState', 'SAFTDefault',
    'DISPID_SpeechGrammarRuleStateTransitions', 'SPSSuppressWord',
    'DISPID_SPPs_NewEnum', 'SINoSignal', 'DISPID_SPRs_NewEnum',
    'DISPID_SGRAttributes', 'SSFMOpenReadWrite',
    'DISPID_SRGCmdLoadFromMemory', 'SPFM_CREATE_ALWAYS',
    'SRTExtendableParse', 'DISPID_SRCVoice', 'DISPID_SPEsCount',
    'SFTSREngine', 'DISPID_SRCEInterference', 'SRERecoOtherContext',
    'DISPID_SRCreateRecoContext', 'SPRST_INACTIVE',
    'SpeechTokenIdUserLexicon', 'SAFTADPCM_8kHzMono',
    'SWPUnknownWordUnpronounceable', 'DISPID_SVSInputWordLength',
    'eLEXTYPE_VENDORLEXICON', 'SASPause', 'ISpNotifySink',
    'SPCT_SUB_DICTATION', 'DISPID_SpeechXMLRecoResult',
    'SpeechTokenKeyAttributes', 'DISPID_SDKGetlongValue',
    'DISPID_SVEViseme', 'DISPIDSPTSI_SelectionOffset',
    'DISPID_SRGCmdLoadFromProprietaryGrammar',
    'SPEI_PROPERTY_STRING_CHANGE', 'SRAImport', 'SVP_6',
    'SVSFParseMask', 'DISPID_SVESentenceBoundary',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN',
    'DISPID_SRCRetainedAudio', 'SVEBookmark',
    'DISPID_SAFSetWaveFormatEx', 'SpeechDisplayAttributes',
    'SAFTText', 'SVSFIsFilename', 'SVSFIsXML',
    'DISPID_SpeechGrammarRules', 'Speech_Max_Word_Length',
    'SVF_Stressed', 'SPSERIALIZEDPHRASE', 'DISPID_SpeechPhraseRules',
    'ISpeechRecoGrammar', 'SP_VISEME_8', 'SPSEMANTICFORMAT',
    'Speech_StreamPos_RealTime', 'DISPID_SPAs_NewEnum', 'tagSTATSTG',
    'DISPID_SpeechVoiceStatus', 'SVSFParseAutodetect',
    'SpNotifyTranslator', 'SAFTCCITT_ALaw_8kHzMono',
    'SVSFNLPSpeakPunc', 'SWTDeleted', 'SLODynamic',
    'SPPS_NotOverriden', 'SAFT44kHz8BitMono', 'SAFT44kHz16BitMono',
    'SPBINARYGRAMMAR', 'SPWF_SRENGINE', 'eWORDTYPE_DELETED',
    'SWPUnknownWordPronounceable', 'ISpeechPhraseRule', 'SP_VISEME_4',
    'SPAS_PAUSE', 'SPPS_RESERVED1', 'DISPID_SRCEEndStream',
    'SVSFVoiceMask', 'SSFMOpenForRead', 'SPRST_ACTIVE',
    'DISPID_SRCEAdaptation', 'SP_VISEME_20',
    'SAFTCCITT_uLaw_11kHzStereo', 'DISPID_SVSPhonemeId',
    'ISpObjectTokenCategory', 'ISpStreamFormat', '_SPAUDIOSTATE',
    'SGSExclusive', '__MIDL___MIDL_itf_sapi_0000_0020_0001',
    'SPBO_PAUSE', 'SVP_1', 'SPSUnknown', 'SPWORDPRONOUNCEABLE',
    ...
    'SpeechRecoContextState', 'DISPID_SABIMinNotification',
    'eLEXTYPE_RESERVED4', 'DISPID_SLGetWords', 'SPEI_WORD_BOUNDARY',
    'SPXMLRESULTOPTIONS', 'SpMMAudioEnum', 'SDTPronunciation',
    'DISPID_SDKOpenKey', 'SPWT_DISPLAY',
    'DISPID_SLAddPronunciationByPhoneIds', 'SVP_9',
    'SPCT_SUB_COMMAND', 'ISpeechWaveFormatEx', 'SpCompressedLexicon',
    'DISPID_SRSCurrentStreamNumber', 'DISPID_SVPause',
    'SPPHRASEREPLACEMENT', 'DISPID_SRSAudioStatus',
    'SRSInactiveWithPurge', 'ISpAudio', 'SPEI_START_SR_STREAM',
    'DISPID_SRGState', 'SPPHRASERULE', 'SPPHRASEPROPERTY',
    'DISPID_SpeechPhraseReplacement', 'SVF_None', 'SPCT_COMMAND',
    'SINoise', 'DISPID_SPPEngineConfidence', 'SVP_11',
    'SDKLDefaultLocation', 'IEnumSpObjectTokens', 'SPSMF_UPS',
    'SVP_15', 'DISPID_SPPParent', 'SP_VISEME_7',
    'DISPID_SASCurrentDevicePosition', 'SPPS_Verb', 'SPCS_DISABLED',
    'SAFT48kHz16BitMono', 'DISPID_SPIStartTime',
    'DISPID_SRAudioInputStream', 'ISpeechVoice', 'DISPID_SLWType',
    'DISPID_SpeechPhraseAlternates', 'SPEI_INTERFERENCE',
    'DISPID_SRGRules', 'DISPID_SRSClsidEngine',
    'DISPID_SRGDictationLoad', 'DISPID_SRRSaveToMemory',
    'DISPID_SpeechPhraseProperty', 'DISPID_SpeechLexiconProns',
    'ISpeechResourceLoader', 'SECHighConfidence', 'SPBO_NONE',
    'SECFNoSpecialChars', 'DISPID_SABIEventBias', 'SPPS_RESERVED3',
    'DISPID_SPEDisplayAttributes', 'SDTReplacement',
    'eLEXTYPE_PRIVATE16', 'SpeechGrammarTagUnlimitedDictation',
    'SAFTNoAssignedFormat', 'SPSHT_Unknown', 'eLEXTYPE_LETTERTOSOUND',
    'SITooQuiet', 'DISPID_SpeechRecoResult2', 'SRAORetainAudio',
    'DISPID_SOTsCount', 'eLEXTYPE_PRIVATE4',
    'DISPID_SRSNumberOfActiveRules', 'SP_VISEME_19', 'SRCS_Enabled',
    'STCAll', 'SPSHT_NotOverriden', 'SPGS_ENABLED',
    'SAFT22kHz16BitMono', 'SAFTGSM610_8kHzMono', 'ISpeechMMSysAudio',
    'SPEI_SOUND_END', 'DISPID_SOTMatchesAttributes',
    'DISPID_SVSInputSentenceLength', 'SITooFast',
    'ISpeechPhraseReplacements', 'SAFT11kHz8BitMono',
    'DISPID_SVSLastStreamNumberQueued', 'SpInProcRecoContext',
    'DISPID_SLWWord', 'SPEI_SR_PRIVATE', 'SpMemoryStream',
    'SGRSTTDictation', 'SVP_20', 'SDA_Consume_Leading_Spaces',
    'SREPhraseStart', 'DISPID_SRCESoundStart',
    'SpeechTokenShellFolder', 'SPCS_ENABLED',
    'Speech_Max_Pron_Length', 'DISPID_SGRSAddRuleTransition',
    'eWORDTYPE_ADDED', 'SpeechCategoryPhoneConverters',
    'SPSHORTCUTPAIR', 'DISPID_SPEDisplayText', 'DISPID_SPCIdToPhone',
    'DISPID_SRCState', 'SPWORDTYPE', 'DISPID_SOTCEnumerateTokens',
    'DISPID_SVEStreamEnd', 'DISPID_SLPType',
    'DISPID_SpeechPhoneConverter', 'DISPID_SGRs_NewEnum',
    'SPRS_ACTIVE', 'SpAudioFormat', 'DISPID_SBSFormat',
    'WAVEFORMATEX', 'SDKLCurrentConfig', 'SpeechVisemeFeature',
    'SREStreamEnd', 'ISpeechObjectToken', 'SP_VISEME_9', 'ISpPhrase',
    'ISpRecoGrammar2', 'SREFalseRecognition', 'SPXRO_Alternates_SML',
    'DISPID_SVWaitUntilDone', 'SPBOOKMARKOPTIONS',
    'SpSharedRecognizer', 'SpeechFormatType',
    'DISPID_SRIsUISupported', 'ISpeechRecognizerStatus',
    'SDTProperty', 'SAFT32kHz8BitMono', 'SpeechVoiceEvents',
    'SAFTCCITT_ALaw_11kHzStereo', 'SpeechAddRemoveWord',
    'SPSNotOverriden', 'eLEXTYPE_RESERVED10', 'SAFT24kHz16BitStereo',
    'SPAS_RUN', 'DISPID_SRCRequestedUIType', 'SAFT24kHz8BitMono',
    'ISpeechPhraseAlternate', 'DISPID_SRStatus',
    'DISPID_SPIAudioSizeTime', 'DISPID_SpeechObjectTokens',
    'SRTEmulated', 'DISPID_SpeechPhraseRule', 'DISPID_SOTCategory',
    ...
    'SAFT16kHz16BitStereo', 'SAFT22kHz8BitStereo', 'SSTTDictation',
    'SPPS_RESERVED2', 'SPFM_NUM_MODES',
    'DISPID_SPERequiredConfidence', 'DISPID_SMSSetData',
    'SPPS_Function', 'DISPID_SRCPause', 'DISPID_SPEPronunciation',
    'DISPID_SpeechObjectTokenCategory', 'DISPIDSPTSI_ActiveLength',
    'DISPID_SVSInputSentencePosition', 'DISPID_SPCLangId',
    'ISpeechAudio', 'SPEI_RECO_STATE_CHANGE',
    'DISPID_SASCurrentSeekPosition', 'DISPID_SRCBookmark',
    'ISpeechBaseStream', 'SAFTCCITT_ALaw_44kHzMono', 'SITooLoud',
    'ISpVoice', 'SpeechGrammarTagDictation', 'ISpMMSysAudio',
    'eLEXTYPE_PRIVATE3', 'SPRECOGNIZERSTATUS', 'SVP_2',
    'DISPID_SVGetAudioInputs', 'SECFIgnoreCase',
    'DISPID_SRGDictationSetState', 'SAFT48kHz16BitStereo',
    'DISPID_SpeechBaseStream', 'DISPID_SRCERequestUI',
    'DISPID_SOTDataKey', 'DISPID_SVSyncronousSpeakTimeout', 'SVP_19',
    'SREHypothesis', 'SAFT16kHz8BitStereo',
    ...
    'STCLocalServer', 'SAFT32kHz16BitStereo', 'SPSHT_OTHER',
    'SBOPause', 'DISPID_SPEAudioTimeOffset',
    'SPRST_INACTIVE_WITH_PURGE', 'SSSPTRelativeToCurrentPosition',
    'DISPID_SpeechLexiconPronunciation', 'DISPID_SGRClear',
    'SGDSActiveWithAutoPause', 'SPRS_ACTIVE_WITH_AUTO_PAUSE',
    'SAFTTrueSpeech_8kHz1BitMono', 'SAFT8kHz8BitMono',
    'DISPID_SpeechAudioBufferInfo', 'DISPID_SpeechVoice',
    'SpObjectToken', 'SPSHT_EMAIL', 'ISpRecoResult',
    'DISPID_SGRSRule', 'DISPID_SRRRecoContext',
    'DISPID_SREmulateRecognition', 'eLEXTYPE_USER_SHORTCUT',
    'SWTAdded', 'DISPID_SOTRemoveStorageFileName', 'SP_VISEME_1',
    'SVSFParseSapi', 'SPWT_LEXICAL', 'DISPID_SPRuleNumberOfElements',
    'DISPID_SGRSTsItem', 'DISPID_SRSSupportedLanguages',
    'ISpeechLexiconPronunciation', 'DISPID_SBSWrite',
    'ISpeechAudioFormat', 'SVSFPersistXML', 'DISPID_SGRAddState',
    'DISPID_SpeechAudioStatus', 'SPFM_OPEN_READWRITE', 'SASStop',
    'SVP_0', 'DISPID_SRCRetainedAudioFormat', 'SpeechBookmarkOptions',
    'DISPID_SRRGetXMLErrorInfo', 'SVP_17',
    'DISPID_SRCCmdMaxAlternates', 'SECLowConfidence',
    'DISPID_SMSADeviceId', 'eLEXTYPE_PRIVATE18', 'SRATopLevel',
    'SpeechMicTraining', 'Speech_Default_Weight',
    'DISPID_SAFGetWaveFormatEx', 'SRAONone', 'SVP_12',
    'DISPID_SpeechRecognizerStatus', 'SPAR_Unknown',
    'SAFTCCITT_uLaw_22kHzMono', 'ISpNotifyTranslator',
    'SPCT_DICTATION', 'SREPrivate', 'eLEXTYPE_PRIVATE13', 'SPPS_Noun',
    'eLEXTYPE_PRIVATE11', 'SpeechCategoryAudioIn',
    '_ISpeechRecoContextEvents', 'SVP_16', 'SVEPrivate',
    'SECFEmulateResult', 'SpeechSpecialTransitionType',
    'ISpEventSource', 'SP_VISEME_3', 'SVSFDefault',
    'SPAUDIOBUFFERINFO', 'eLEXTYPE_PRIVATE17',
    'ISpeechPhoneConverter', 'DISPID_SVEventInterests',
    'DISPID_SLGetPronunciations', 'SP_VISEME_5', 'DISPID_SGRsDynamic'
]

_check_version('1.1.14', 1610760068.159179)
